  ...
  <div class="mftcc-layout-header">
    <div class="outer-west-logo">
      ...
      <img class="layout-logo"
           style="width: 40px;width: 55px"
           :src="logo" />
      <span>综合业务管理平台</span>
      <!--      </div>-->
      <img class="layout-title"
           :src="logoTitle" />
    </div>
    <div class="middle-north-east"
         @click="fixedMenu">
      <img style="height:26px;width:26px;background-size:100% 100%;"
           src="@/theme/blue/images/option.png" />
    </div>
