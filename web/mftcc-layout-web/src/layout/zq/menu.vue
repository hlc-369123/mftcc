    ...
    <div class="mftcc-user">
      <div class="user-base">
        ...
        <div class="user-info">
          ...
          <div class="user-role">
            {{ user.roleName?user.roleName:'人事专员岗位' }}
        ...
        <template v-for="item in menuData">
          <el-submenu :key="item.id"
            ...
            <el-menu-item v-for="citem in item.children"
              ...
              <template slot="title">
                <i class="icon zq-icon zq-wendang"></i>
...
export default {
  ...
  mounted() {
    ...
    this.microAppHeight = document.body.clientHeight - 215;
  },
  methods: {
    ...
    navRouter(item) {
      ...
      if (url && children == undefined && newTab != 0) {
        ...
        this.reload();
      } else if (url && children == undefined && newTab == 0 && this.$route.query.menuId) {
        this.multilevelMenu = false;
        singleSpaNavigate(url);
        this.activeIndex = this.$refs.menu.activeIndex;
        this.reload();
