<template>
    <div class="mftcc-container">
        ...
        <el-container>
        <el-row>
            <mftcc-form formId="sys/sysDeptUpdate" :parentVm="this" ref="sysDeptUpdateForm"></mftcc-form>
...
export default {
    ...
    methods: {
        submitForm() {
            this.$refs.sysDeptUpdateForm.validateForm((valid) => {
                if (valid) {
                    let data = this.$refs.sysDeptUpdateForm.getFormValue();
        ...
        findById(){
            ...
            api.findById(brId,reponse => {
                if(reponse.code === 0){
                    ...
                    this.$refs.sysDeptUpdateForm.setFormValue(data);
                }else{
                    this.$alert(reponse.msg, this.$alertTitle, {
                    type: reponse.msgType,
                    callback: action => {
